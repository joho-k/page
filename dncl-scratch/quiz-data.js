window.quizData = {
    ...
    q012: {
        ...
        addedAt: "2026-06-18",
        difficulty: 4,
        question: "3人の友だちに、おかしを1人あたり同じ数ずつ配ります。kosu は配ったおかしの合計で、内側のくり返しを1回まわるたびに kosu + 1 しておかしを1個わたします。外側のくり返し（hito）は3人ぶん、内側のくり返し（okashi）は1人にわたすおかしです。配ったおかしが全部で12個（kosu が 12）になるように、内側のくり返し（1人にわたす個数）の終わりの値をうめよう",
        ast: [
            {
                type: "assign",
                name: "kosu",
        ...
        answers: [
            ...
            },
            {
                values: ["3"],
                correct: false,
                hint: "1人に3個だと 3×3=9個にしかなりません。全部で12個にするには1人に4個わたそう",
            },
            {
                values: ["12"],
                correct: false,
                hint: "12は答え（おかしの合計）です。内側のくり返しは1個ずつわたすので、1人にわたす個数（4）を入れよう。3×4=12です",
            },
            {
                values: ["2"],
                correct: false,
                hint: "1人に2個だと 3×2=6個にしかなりません",
            }
        ],
        defaultHint: "内側のくり返しが1回まわるたびに kosu が1ふえて、おかしを1個わたします。1人に□個、それが3人ぶんくり返されるので kosu は 3×□。これが12になる□（＝内側の終わりの値）を考えよう"
    }
}
