window.quizData = {
    ...
    q048: {
        title: "50時間後は何時？（時計のひとまわり）",
        addedAt: "2026-08-22",
        difficulty: 2,
        question: "いまは14時です。50時間後は何時になるでしょうか。時計は24時間でちょうどひとまわりして0時にもどります。まず今の時刻に経過した時間をたし、そのあと「24でわったあまり」を求めると、ひとまわりしたぶんを取りのぞいた時刻がわかります（2か所の穴をうめよう）",
        ast: [
            {
                type: "assign",
                name: "ima",
            ...
            },
            {
                type: "assign",
                name: "goukei",
                value: "ima __BLANK_blank_a__ keika"
            },
            {
                type: "assign",
                name: "jikoku",
                value: "goukei __BLANK_blank_b__ 24"
            },
            {
                type: "print",
                value: "\"たすと\" + goukei + \"時、ひとまわりを取りのぞくと\" + jikoku + \"時です\""
            }
        ],
        choices: [
            { label: "+", value: "+" },
        ...
        answers: [
            ...
            },
            {
                values: ["+", "/"],
                correct: false,
                hint: "/ はわり算の「商」なので、64 / 24 ＝ 2.66… となり「何回ひとまわりしたか」に近い数が出ます。知りたいのはひとまわりしたあとに残る時刻なので、あまりを出す % を使いましょう",
            },
            {
                values: ["+", "-"],
                correct: false,
                hint: "64 - 24 ＝ 40 では、まだ24をこえているので時計の時刻になっていません。24を何回でも引ける「あまり」の考え方が % です。% なら一度で 64 % 24 ＝ 16 が出ます",
            },
            {
                values: ["+", "+"],
                correct: false,
                hint: "64 + 24 ＝ 88 では、時刻がさらに大きくなってしまいます。ひとまわりぶんを取りのぞきたいので、たし算ではなく、あまりを出す % を使います",
            },
            {
                values: ["+", "*"],
                correct: false,
                hint: "64 * 24 ＝ 1536 では時刻とかけはなれてしまいます。24時間でひとまわりすることを式にするなら、24でわったあまり（%）です",
            },
            {
                values: ["-", "%"],
                correct: false,
                hint: "14 - 50 ＝ -36 と、時刻がマイナスになってしまいます。50時間「後」なので、今の時刻に経過時間をたす + が正しいです",
            },
            {
                values: ["*", "%"],
                correct: false,
                hint: "14 * 50 ＝ 700 は、14時が50個ぶんという意味になってしまいます。時刻を先に進めたいだけなので、たし算の + を使いましょう",
            },
            {
                values: ["/", "%"],
                correct: false,
                hint: "14 / 50 ＝ 0.28 では時刻になりません。50時間後の時刻を知りたいので、まず 14 + 50 ＝ 64 と、今の時刻に経過時間をたします",
            },
            {
                values: ["%", "%"],
                correct: false,
                hint: "14 % 50 ＝ 14 となり、時間がまったく進みません。1つめの穴は「時刻を進める」ところなので + です。あまりを使うのは2つめの穴だけです",
            }
        ],
        defaultHint: "手順は2つ。①今の時刻に経過時間をたす（14 + 50 ＝ 64）②24でわったあまりを求める（64 % 24 ＝ 16）。24時間でひとまわりして0にもどるものは、% 24 で「今どこにいるか」が一発で出せます。曜日（% 7）や分・秒（% 60）も同じ考え方です",
    },
}
