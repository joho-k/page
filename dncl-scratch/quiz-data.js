window.quizData = {
    ...
    q049: {
        title: "パケットは何個必要？（切り上げ）",
        addedAt: "2026-08-23",
        difficulty: 3,
        question: "インターネットでは、データを「パケット」という小さなかたまりに分けて送ります。8000バイトのデータを、1個に1500バイトまで入るパケットで送るとき、パケットは何個必要かを表示しよう。まず、いっぱいまで詰めたパケットが何個できるかを wari で計算して切り捨て、そこに入りきらずに残るデータ（あまり）を求めます。残りが少しでもあるなら、そのぶんをのせるパケットがもう1個いります。あてはまる記号を選ぼう（3か所の穴をうめよう）",
        ast: [
            {
                type: "assign",
                name: "data",
            ...
            },
            {
                type: "assign",
                name: "wari",
                value: "data __BLANK_blank_a__ size"
            },
            {
                type: "assign",
                name: "manpai",
            ...
            },
            {
                type: "assign",
                name: "amari",
                value: "data __BLANK_blank_b__ size"
            },
            {
                type: "ifelse",
            ...
            {
                type: "print",
                value: "\"いっぱいのパケットは\" + manpai + \"個\""
            },
            {
                type: "print",
                value: "\"入りきらない残りは\" + amari + \"バイト\""
            },
            {
                type: "print",
                value: "\"必要なパケットは\" + kosuu + \"個\""
            }
        ],
        choices: [
            { label: "+", value: "+" },
        ...
        answers: [
            ...
            },
            {
                values: ["%", "%", "=="],
                correct: false,
                hint: "1つ目の wari は「いっぱいまで詰めたパケットが何個ぶんか」なので、わり算です。% だと 8000 % 1500 ＝ 500 とあまりのほうが出てしまい、切り捨てても500個のままです。8000 / 1500 ＝ 5.33… を切り捨てて 5 個と求めましょう",
            },
            {
                values: ["/", "/", "=="],
                correct: false,
                hint: "2つ目は「入りきらずに残るデータ」です。/ だと 8000 / 1500 ＝ 5.33… となり、残りが5.33バイトという意味の分からない値になります。あまりを出す % を使って 8000 % 1500 ＝ 500 バイトと求めましょう",
            },
            {
                values: ["/", "-", "=="],
                correct: false,
                hint: "パケットは5個ぶん詰めているので、ひくなら 8000 - 1500 * 5 です。- だと1個ぶんの 8000 - 1500 ＝ 6500 しかひけません。何個ぶんでも一度にひいてくれる % を使いましょう",
            },
            {
                values: ["/", "%", "!="],
                correct: false,
                hint: "この if は「残りが0のとき（ぴったり収まったとき）」に manpai をそのまま使う形です。!= だと残り500バイトのときに manpai ＝ 5 個となり、あまった500バイトを運ぶパケットが足りません。残りが0かどうかを == でたずねましょう",
            },
            {
                values: ["/", "%", ">"],
                correct: false,
                hint: "> だと「残りがある」ときに manpai をそのまま使うことになり、5個で止まってしまいます。もう1個いるのは残りがあるときなので、条件は == で「残りが0のとき」だけ manpai のまま、という向きにします",
            }
        ],
        defaultHint: "「何個に分ける？」は切り上げの計算です。8000 / 1500 ＝ 5.33… を切り捨てた 5 個と、あまり 8000 % 1500 ＝ 500 バイトを別々に求め、あまりが0でなければ 5 に1をたします。8000バイトなら 5 + 1 ＝ 6 個です",
    },
}
