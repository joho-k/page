window.quizData = {
    ...
    q056: {
        ...
        addedAt: "2026-09-11",
        difficulty: 3,
        question: "「当たりが出る確率40%」のおみくじを作ろう。関数 omikuji は、乱数()を使って0以上1未満のランダムな数を r に入れ、r と 0.4 をくらべて「当たり」か「はずれ」を返します。当たりが出る確率がちょうど40%になるように、1箇所の穴を埋めよう",
        ast: [
            {
                type: "func",
                name: "omikuji",
                ...
                body: [
                    ...
                    {
                        type: "ifelse",
                        condition: "r __BLANK_blank_a__ 0.4",
                        ifBody: [
                            {
                                type: "return",
                                value: "\"当たり\""
        ...
        answers: [
            ...
            },
            {
                values: [">"],
                correct: false,
                hint: "向きが逆です。> だと 0.4 より大きいほうが当たりになります。0.4 から 1 までは帯の6割なので、確率60%のおみくじになってしまいます。当たりにしたいのは小さいほうの4割です",
            },
            {
                values: [">="],
                correct: false,
                hint: "向きが逆です。>= だと 0.4 から 1 までが当たりになり、6割＝60%になってしまいます。0 から 0.4 までを当たりにする記号を選びましょう",
            },
            {
                values: ["=="],
                correct: false,
                hint: "== は「ぴったり同じか」を調べる記号です。乱数() が返すのは 0.2836… のような細かい小数なので、ちょうど 0.4 になることはまずありません。何回引いてもほとんど「はずれ」になってしまいます",
            }
        ],
        defaultHint: "乱数() は 0 以上 1 未満の数を返します。0 から 1 までの帯のうち、0 から 0.4 までのぶんがちょうど4割。この「0.4 より小さいほう」を当たりにしたいので、r と 0.4 をくらべる記号は < です。乱数を使っているので実行するたびに結果は変わりますが、何回もためすと4割くらいが「当たり」になります"
    },
}
