window.quizData = {
    ...
    q061: {
        title: "あまりが出たらもう1回（ロープウェイは何回？）",
        addedAt: "2026-09-06",
        difficulty: 3,
        question: "38人のクラスが、定員7人のロープウェイに乗ります。全員を運ぶには何回動かせばよいかを表示しよう。38 / 7 ＝ 5.42… なので、まるまる7人乗せられるのは5回。それでも乗りきれない人が残るなら、もう1回動かさなければいけません。あてはまる記号を選ぼう（3か所の穴をうめよう）",
        ast: [
            {
                type: "assign",
                name: "ninzu",
            ...
            },
            {
                type: "assign",
                name: "kaisu",
                value: "切り捨て(ninzu / teiin)"
            },
            {
                type: "assign",
                name: "nokori",
                value: "ninzu __BLANK_blank_a__ teiin"
            },
            {
                type: "if",
                condition: "nokori __BLANK_blank_b__ 0",
                body: [
                    {
                        type: "assign",
                        name: "kaisu",
            ...
            {
                type: "print",
                value: "\"乗りきれない人は\" + nokori + \"人\""
            },
            {
                type: "print",
                value: "\"ロープウェイは\" + kaisu + \"回動かします\""
            }
        ],
        choices: [
            { label: "%", value: "%" },
        ...
        answers: [
            ...
            },
            {
                values: ["/", ">", "+"],
                correct: false,
                hint: "38 / 7 ＝ 5.428… は「何回分乗せられるか」であって、乗りきれずに残った人数ではありません。「乗りきれない人は5.428…人」と表示されてしまいます。わったあまりを出す % を使いましょう"
            },
            {
                values: ["-", ">", "+"],
                correct: false,
                hint: "38 - 7 ＝ 31 は「1回運んだあとの残り」でしかなく、5回運んだあとの残りではありません。「乗りきれない人は31人」と出てしまいます。7人ずつ運びきったあとの残りは 38 % 7 ＝ 3 です"
            },
            {
                values: ["*", ">", "+"],
                correct: false,
                hint: "38 * 7 ＝ 266 で、クラスの人数より多くなってしまいます。わったあとに残る人数を求めたいので % を使いましょう"
            },
            {
                values: ["%", "==", "+"],
                correct: false,
                hint: "nokori == 0 は「ちょうど割り切れたとき」です。割り切れたなら追加の1回はいりません。逆に残りが3人いるときこそ、もう1回動かす必要があります。0より大きいかを調べる > にしましょう"
            },
            {
                values: ["%", "<", "+"],
                correct: false,
                hint: "あまりはマイナスにならないので、nokori < 0 は一度も成り立ちません。kaisu は5回のままになり、残った3人が乗れなくなります。0より大きいかを調べる > を使います"
            },
            {
                values: ["%", ">=", "+"],
                correct: false,
                hint: "nokori >= 0 はあまりが0のときも成り立つので、ちょうど割り切れる場合（例えば35人なら5回でぴったり）にもむだな1回が足されてしまいます。残りがあるときだけ足したいので > です"
            },
            {
                values: ["%", ">", "-"],
                correct: false,
                hint: "5 - 1 ＝ 4回になり、運ぶ回数が減ってしまいます。乗りきれない人を運ぶために「もう1回」増やしたいので + です"
            },
            {
                values: ["%", ">", "*"],
                correct: false,
                hint: "5 * 1 ＝ 5 なので、かけても回数は5回のまま変わりません。1回ふやすには + を使います"
            },
            {
                values: ["/", ">", "*"],
                correct: false,
                hint: "2か所ちがいます。残りの人数は 38 % 7 ＝ 3 で求め、その残りがいるときは kaisu + 1 として回数を1ふやします"
            }
        ],
        defaultHint: "「わり算の答えを切り上げる」は、共通テストでもよく出る考え方です。まず 切り捨て(38 / 7) ＝ 5 でまるまる運べる回数を出し、38 % 7 ＝ 3 で乗りきれない人を調べ、その人が1人でもいれば（> 0）回数に +1 します"
    },
}
