window.quizData = {
    ...
    q059: {
        ...
        addedAt: "2026-09-03",
        difficulty: 4,
        question: "じゃんけんの手を グー＝0、チョキ＝1、パー＝2 という数字で表します。Aさんはパー（2）、Bさんはグー（0）を出しました。グー→チョキ→パー→グー…と3つの手はひとまわりしているので、sa ＝ te_a - te_b + 3 を「3でひとまわり」させた値 kekka を見ると、0のときはあいこ、そうでないときは勝ち負けが決まります。勝ち負けを正しく表示するには、あてはまるものはどれ？（2か所の穴をうめよう）",
        ast: [
            {
                type: "assign",
                name: "te_a",
            ...
            },
            {
                ...
                elseBody: [
                    {
                        type: "ifelse",
                        condition: "kekka == __BLANK_blank_b__",
                        ifBody: [
                            {
                                type: "print",
                                value: "\"Aさんの勝ち\""
        ...
        answers: [
            ...
            },
            {
                values: ["-", "2"],
                correct: false,
                hint: "5 - 3 ＝ 2 なので、この組み合わせだけはたまたま「Aさんの勝ち」と正しく出ます。でもグー（0）とパー（2）を入れかえると sa は 0-2+3 ＝ 1 で、1 - 3 ＝ -2 というマイナスの値になり、判定できません。0〜2 にきちんとおさめるには、ひくのではなく、わったあまりを出す % を使います"
            },
            {
                values: ["/", "2"],
                correct: false,
                hint: "/ は商なので 5 / 3 ＝ 1.66… という小数になり、kekka == 2 にも 0 にもならず「Bさんの勝ち」と表示されます。「3つでひとまわり」を数字にするのは、商ではなく、わったあまりの % です"
            },
            {
                values: ["*", "2"],
                correct: false,
                hint: "* だと 5 * 3 ＝ 15 とどんどん大きくなり、0・1・2 のどれにもなりません。手は3つでひとまわりするので、3 でわったあまりを出す % を使います"
            },
            {
                values: ["/", "1"],
                correct: false,
                hint: "2か所ちがいます。ひとまわりの計算はわり算の商（/）ではなく、あまり（%）です。そして 5 % 3 ＝ 2 なので、Aさんが勝つ番号は 1 ではなく 2 です"
            },
            {
                values: ["*", "3"],
                correct: false,
                hint: "2か所ちがいます。かけ算では 0〜2 におさまりません。3 でわったあまり（%）を出し、Aさんが勝つ番号 2 とくらべましょう"
            }
        ],
        defaultHint: "グー（0）→チョキ（1）→パー（2）→グー…と手は3つでひとまわりします。Aさんはパー（2）、Bさんはグー（0）なので sa ＝ 2 - 0 + 3 ＝ 5。これを 3 でわったあまり（%）にすると 5 % 3 ＝ 2 です。じつは「グーがチョキに勝つ」「チョキがパーに勝つ」ときも同じ 2 になるので、kekka が 2 のときがAさんの勝ちです"
    },
}
