window.quizData = {
    ...
    q056: {
        ...
        addedAt: "2026-09-11",
        difficulty: 3,
        question: "「当たりが出る確率40%」のおみくじを作ろう。関数 omikuji は、乱数()を使って0以上1未満のランダムな数を r に入れ、r が当たりの範囲におさまっていれば「当たり」、そうでなければ「はずれ」を返すように、1箇所の穴を埋めよう",
        ast: [
            {
                type: "func",
                name: "omikuji",
        ...
        answers: [
            ...
            },
            {
                values: ["0.6"],
                correct: false,
                hint: "0.6 だと、0 から 0.6 までが当たりの範囲になります。これは全体の6割なので60%です。当たりを4割にしたいので、区切るところは 0.4 です",
            },
            {
                values: ["4"],
                correct: false,
                hint: "乱数() が返すのは0以上1未満の数なので、r は必ず 4 より小さくなります。つまり r < 4 はいつでも成り立ち、10回引けば10回とも当たり＝100%です。40%は「0.4」と書きます",
            },
            {
                values: ["40"],
                correct: false,
                hint: "40% の「40」をそのまま入れたくなりますが、r は0以上1未満の数なので、r < 40 はいつでも成り立ちます。ぜんぶ当たりになってしまいます。1 のうちの4割なので 0.4 です",
            }
        ],
        defaultHint: "乱数() は 0 以上 1 未満の数を返します。0 から 1 までの帯のうち、0 から 0.4 までのぶんはちょうど4割。だから r < 0.4 を当たりにすれば、確率40%のおみくじになります。乱数を使っているので実行するたびに結果は変わりますが、何回もためすと4割くらいが「当たり」になります"
    },
}
