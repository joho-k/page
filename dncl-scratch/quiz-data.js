    ...
    q060: {
        ...
        answers: [
            ...
            },
            {
                values: ["1", ">=", "+"],
                correct: false,
                hint: ">= にすると「自分と同じ点」も数えてしまいます。j は自分自身も通るので、どの人も必ず1人分多く数えてしまい、70点は5位、90点は2位と、全員が1つずつ下にずれます。数えたいのは「自分より高い人」だけなので > を使います"
            },
            {
                values: ["1", "<", "+"],
                correct: false,
            ...
            },
            {
                values: ["0", ">=", "+"],
                correct: false,
                hint: "2か所ちがいますが、偶然どの人も正しい順位になります。>= で自分自身を余分に1人数えている分を、スタートの 0 が打ち消しているだけです。意味を考えると「juni は1位からスタート」「数えるのは自分より高い人だけ（>）」が正しい組み合わせです"
            },
            {
                values: ["0", "<", "+"],
                correct: false,
