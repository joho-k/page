window.quizData = {
    ...
    q047: {
        ...
        addedAt: "2026-08-21",
        difficulty: 5,
        question: "白黒画像の1行ぶんのデータ data（＝[1,1,1,1,1,1,0,0,0,1,1,0]、1が黒・0が白）を、ランレングス圧縮でまとめよう。ランレングス圧縮は「同じ数が何個続いたか」を数えて「1が6個」「0が3個」…と短く表す方法です。前の数を ima、続いた個数を kosuu にとっておき、前と同じ数ならふやし、ちがう数になったらそこまでの組を表示して数え直します。最後に、圧縮後がいくつの数で表せるかも計算します。あてはまる記号を選ぼう（3か所の穴をうめよう）",
        ast: [
            {
                type: "assign",
                name: "data",
