window.quizData = {
    ...
    q054: {
        ...
        addedAt: "2026-08-26",
        difficulty: 3,
        question: "シーザー暗号は、アルファベットを決まった数だけ後ろにずらして文字をかくす暗号です。A を1、B を2、… 、Z を26として、W X Y Z を番号にした配列 moji（＝[23,24,25,26]）を、zure（＝3）だけずらした番号にして表示しよう。左から moji[0], moji[1], … , moji[3] の4個です。ずらした結果が26をこえたときだけ、A にもどるように26をひいて折り返します。26（＝Z）はまだ折り返さないことに気をつけよう（2か所の穴をうめよう）",
        ast: [
            {
                type: "assign",
                name: "zure",
            ...
            },
            {
                ...
                body: [
                    ...
                    {
                        type: "if",
                        condition: "ban __BLANK_blank_a__ 26",
                        body: [
                            {
                                type: "assign",
                                name: "ban",
                                value: "ban __BLANK_blank_b__ 26"
                            }
                        ]
                    },
                    {
                        type: "print",
                        value: "\"もとの番号\" + moji[i] + \"は\" + ban + \"になります\""
                    }
                ]
            }
        ],
        ...
        answers: [
            ...
            },
            {
                values: [">=", "-"],
                correct: false,
                hint: ">= だと26そのものも折り返してしまいます。26は Z のことなので、まだアルファベットの中におさまっています。折り返すのは26をこえた27からなので > を使います"
            },
            {
                values: ["<", "-"],
                correct: false,
                hint: "< だと向きが逆で、26より小さいときに26をひいてしまいます。ひくのは26をこえたときです"
            },
            {
                values: [">", "+"],
                correct: false,
                hint: "条件は合っています。でも + だと27がさらに大きくなって53になってしまいます。26をこえたぶんを A から数えなおすので、26をひきます"
            },
            {
                values: [">=", "+"],
                correct: false,
                hint: "2か所とも違います。折り返すのは26をこえたとき（>）で、そのときは26をひきます（-）"
            },
            {
                values: ["<", "+"],
                correct: false,
        ...
        defaultHint: "A=1, B=2, …, Z=26 なので、番号は1〜26の間にあれば正しいアルファベットです。23+3=26 は Z のままでよく、24+3=27 は26をこえたので27-26=1、つまり A にもどります。「こえたとき」だけ折り返すので、条件は >= ではなく > です"
    },
}
