window.quizData = {
    ...
    q058: {
        title: "15分後は何時何分？（時刻のくり上がり）",
        addedAt: "2026-09-12",
        difficulty: 2,
        question: "いまの時刻は9時45分です。15分後の時刻を「10時0分」のように表示しよう。時は ji、分は fun に入っています。fun に15をたしたあと、分が60以上になったら、60分を1時間にくり上げます。くり上げるかどうかを決める記号と、分の直し方の2か所の穴をうめよう",
        ast: [
            { type: "assign", name: "ji", value: "9" },
            { type: "assign", name: "fun", value: "45" },
            { type: "assign", name: "fun", value: "fun + 15" },
            {
                type: "if",
                condition: "fun __BLANK_blank_a__ 60",
                body: [
                    { type: "assign", name: "fun", value: "fun __BLANK_blank_b__ 60" },
                    { type: "assign", name: "ji", value: "ji + 1" }
                ]
            },
            { type: "print", value: "ji + \"時\" + fun + \"分\"" }
        ],
        choices: [
            { label: ">", value: ">" },
            { label: ">=", value: ">=" },
        ...
        answers: [
            { values: [">=", "-"], correct: true },
            {
                values: [">", "-"],
                correct: false,
                hint: "45 + 15 で fun はちょうど 60 になります。60 > 60 は「60は60より大きい」なので偽になり、くり上がらずに「9時60分」と表示されてしまいます。60分ちょうどは1時間なので、60 もふくむ >= を使います"
            },
            {
                values: ["<", "-"],
                correct: false,
                hint: "60 < 60 は偽なので、くり上がらずに「9時60分」になります。しかも < だと、分が 30 のように60より小さいときにくり上がってしまい、動きが逆です。「60以上」は >= で書きます"
            },
            {
                values: [">=", "+"],
                correct: false,
                hint: "くり上げる条件は合っています。でも fun = fun + 60 だと 60 + 60 ＝ 120 になり、「10時120分」と表示されてしまいます。60分を1時間として時のほうへ移すので、分からは 60 をひきます"
            },
            {
                values: [">", "+"],
                correct: false,
                hint: "2か所とも違います。60 > 60 は偽なのでくり上がらず「9時60分」になります。さらに、くり上がったときも fun + 60 では分がふえてしまいます。条件は >=、分の直し方は - です"
            },
            {
                values: ["<", "+"],
                correct: false,
                hint: "2か所とも違います。60 < 60 は偽なのでくり上がらず「9時60分」になります。条件は「60以上」なので >=、くり上げたら分から 60 をひくので - です"
            }
        ],
        defaultHint: "時計の分は 0 から 59 までで、60分になったら1時間にくり上がります。45 + 15 ＝ 60 なので、60 ちょうどのときもくり上げたい。だから条件は fun >= 60 です。くり上げるときは、分から 60 をひいて（60 - 60 ＝ 0）、時に 1 をたします（9 + 1 ＝ 10）。「10時0分」と表示されれば正解です"
    },
}
