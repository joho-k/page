window.quizData = {
    ...
    q046: {
        ...
        addedAt: "2026-08-25",
        difficulty: 2,
        question: "1時間あたり300円の駐車場があります。1時間から5時間までとめたときの料金の早見表を、上から順に表示しよう。何時間目かを数えている変数は i です。くり返しの終わりの数と、料金を計算する記号の2か所の穴をうめよう",
        ast: [
            {
                type: "for",
                varName: "i",
        ...
        answers: [
            ...
            },
            {
                values: ["5", "+"],
                correct: false,
                hint: "300 + i では1時間ごとに1円ずつしか増えません。1時間で301円になってしまいます。「1時間あたり300円」は300を時間の数だけかけるので * を使います",
            },
            {
                values: ["5", "/"],
                correct: false,
                hint: "300 / i では時間がのびるほど安くなってしまいます。2時間で150円ではおかしいですね。* を使って 300 * 2 ＝ 600 とします",
            },
            {
                values: ["5", "-"],
                correct: false,
                hint: "300 - i では1時間ごとに1円ずつ安くなってしまいます。「1時間あたり300円」は300を時間の数だけかけるので * を使います",
            }
        ],
        defaultHint: "料金は「1時間あたりの金額 × とめた時間」なので 300 * i です。for は終わりの数もふくめてくり返すので、1時間から5時間までなら 1 から 5 までと書きます。300円、600円、900円、1200円、1500円と5行出れば正解です"
    },
}
